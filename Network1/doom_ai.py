...
class Parameters():
    def __init__(self, learning_rate=lr, discount_factor=discount_factor, train_epochs=train_epochs, learning_steps_per_epoch=learning_steps_per_epoch, replay_memory_size=replay_memory_size, batch_size=batch_size, frame_repeat=frame_repeat, config_file_path=config_file_path, learing=learing, testing=testing, episodes=episodes_to_watch):
